...
function FileDrop({
  ...
  const uploadImage1 = async (e) => {
    ...
    const base641 = await convertBase641(files);
    //console.log(base64);
    setBaseImage1(base641);
    sessionStorage.setItem("image1", JSON.stringify(base641));
    return base641;
  };
  ...
  const uploadImage2 = async (e) => {
    console.log(e.target.files);
    const files = e.target.files[0];
    const base642 = await convertBase642(files);
    //console.log(base64);
    setBaseImage2(base642);
    sessionStorage.setItem("image2", JSON.stringify(base642));
    return base642;
  };
  ...
  const uploadImage3 = async (e) => {
    console.log(e.target.files);
    const files = e.target.files[0];
    const base643 = await convertBase643(files);
    //console.log(base64);
    setBaseImage3(base643);
    sessionStorage.setItem("image3", JSON.stringify(base643));
    return base643;
  };
